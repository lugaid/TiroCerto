						...
						<div id="controls" class="controls form-inline">
							...
							<div class="input-append date"
								...
								<input class="span2" size="16" type="text"
									readonly="" value="<fmt:formatDate value="${championshipStage.date.time}" pattern="MM/dd/yyyy"/>"><span class="add-on"><i
...
<script type="text/javascript">
	...
	$(document).ready(function(){
        $("#addChampionshipStage").click(function(){
			...
			newMod += '<input class="span2" size="16" type="text" readonly=""><span class="add-on"><i class="icon-calendar"></i></span>';
			newMod += '</div>';
			newMod += '</div>';
            newMod += '</div>';
